...
<!-- End Google Tag Manager -->
    ...
    <meta name="Formules" content="Amand'Innov Web propose différentes formules modifiables et adaptables pour la création de votre site internet personnalisé sur Rouen Normandie.">
    <link rel="icon" type="image/x-icon" sizes="16x16"  href="./assets/img/favicon/favicon.ico">
    <title>Amand'Innov Web | Création de votre site internet à Rouen en Normandie | Les formules</title>
