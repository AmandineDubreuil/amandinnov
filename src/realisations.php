...
<!-- End Google Tag Manager -->
    ...
    <meta name="Réalisations" content="Exemples de créations de sites vitrine et applications web créés sur Rouen Normandie">
    <link rel="icon" type="image/x-icon" sizes="16x16"  href="./assets/img/favicon/favicon.ico">

    <title>Amand'Innov Web | Création de votre site internet à Rouen en Normandie | Les réalisations</title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="cards">
        ...
        <div class="card">
            <a href="https://www.lechalprev.fr/" target="blank">
                <div class="cardHeader">
                    <img src="./assets/img/lechalprev.jpg" alt="site lechalprev.fr">
                ...
                <div class="cardBody">
                    ...
                    <ul class="cardList">
                        <li><span class="check"><img src="./assets/img/check-primary-light.png" alt="checked"></span> 3 pages</li>
                        ...
                        <li><span class="check"><img src="./assets/img/check-primary-light.png" alt="checked"></span> Titre dynamique
                        </li>
